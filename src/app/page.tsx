    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
        ...
        >
          <motion.div variants={fadeInUp} className="mb-8">
            <img 
              ...
              alt="Owner Usman"
              className="w-32 h-32 md:w-48 md:h-48 rounded-full mx-auto border-4 border-yellow-400 shadow-2xl object-cover"
            />
          </motion.div>
          ...
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/menu">
              <button className="btn-primary text-lg flex items-center justify-center gap-2 w-full sm:w-auto">
                Order Now <ArrowRight className="w-5 h-5" />
              </button>
            </Link>
            <Link href="/about">
              <button className="btn-secondary text-lg flex items-center justify-center gap-2 w-full sm:w-auto">
      ...
      <section className="py-20 md:py-32 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-black mb-4 text-black">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="bg-gradient-to-br from-yellow-400 to-yellow-500 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 text-black group-hover:scale-110 transition-transform duration-300 shadow-lg">
                  {feature.icon}
                </div>
      ...
      {/* CTA Section */}
      <section className="py-20 md:py-32 bg-gradient-to-r from-yellow-400 to-orange-400">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          ...
          <Link href="/menu">
            <button className="bg-black text-yellow-400 font-bold py-4 px-10 rounded-lg text-lg hover:bg-gray-900 transition-all transform hover:scale-105 shadow-2xl">
              View Full Menu
            </button>
          </Link>
        </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400">Serving delicious food with love since 2020</p>
            </div>
            <div>
